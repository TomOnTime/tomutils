...
var tokens = []struct {
	...
	//{"EPISODE_NUM", "10"},
	//{"GUEST_NAME", "Clay Caviness and Edward Eigerman"},
	//{"GUEST_PRONOUN", "they"},
	//{"ORIG_TITLE", "Managing Macs at Google Scale"},
	//{"ORIG_CONFNAME", "LISA '13"},
	//{"ORIG_LISTING", "https://www.usenix.org/conference/lisa13/managing-macs-google-scale"},
	//{"ORIG_SLIDES", "DELETE"},
	//{"ORIG_YOUTUBE", "DELETE"},
	//{"ONAIR_LINK", "DELETE"},
	//{"EPISODE_YOUTUBE", "https://www.youtube.com/watch?v=tCyY0B7T4tg"},
	//{"EPISODE_DATE", "Tuesday, May 31, 2016"},
	//{"EPISODE_TIME", "3:30-4:30 p.m. PT"},
	//{"EPISODE_CONVERT", "http://www.timeanddate.com/worldclock/converted.html?iso=20160531T1530&p1=224&p2=179"},

	{"EPISODE_NUM", "11"},
	{"GUEST_NAME", "Russell Pavlicek"},
	{"GUEST_PRONOUN", "his"},
	{"ORIG_TITLE", "Unleashing the Power of the Unikernel"},
	{"ORIG_CONFNAME", "LISA '15"},
	{"ORIG_LISTING", "https://www.usenix.org/conference/lisa15/conference-program/presentation/pavlicek"},
	{"ORIG_SLIDES", "DELETE"},
	{"ORIG_YOUTUBE", "DELETE"},
